  ...
  return (
    <div>
      ...
      <p className="mb-6 text-lg">
          <strong className="text-xl text-blue-600">Orjinal Metin:</strong> <span className="text-gray-700"> {response.original_text} </span>
        </p>
        <p className="mb-6 text-lg">
          <strong className="text-xl text-blue-600">Transkripte Metin:</strong> <span
      ...
      <table className="min-w-full table-auto border-collapse mt-6">
          <thead>
            <tr className="bg-gray-200">
              ...
              <th className="px-4 py-2 border-b text-left">Diğer Hatalar (Other Errors)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td className="px-4 py-2 border-b">{response.errors?.other_errors}</td>
            </tr>
        </tbody>
      </table>
    </div>
